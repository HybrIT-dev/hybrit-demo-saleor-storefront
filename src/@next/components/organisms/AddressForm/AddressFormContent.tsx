    ...
    >
      <S.Wrapper>
        ...
        <S.RowWithTwoCells>
          <TextField
            ...
            label={intl.formatMessage({
              defaultMessage: "Bedrijfsnaam (optioneel)",
            })}
        ...
        <S.RowWithOneCell>
          <TextField
            name="streetAddress1"
            label={intl.formatMessage({ defaultMessage: "Adres regel 1" })}
        ...
        <S.RowWithOneCell>
          <TextField
            name="streetAddress2"
            label={intl.formatMessage({ defaultMessage: "Adres regel 2" })}
        ...
        <S.RowWithTwoCells>
          <TextField
            name="city"
            label={intl.formatMessage({ defaultMessage: "Stad" })}
            value={values!.city}
        ...
        <S.RowWithTwoCells>
          <InputSelect
            ...
            label={intl.formatMessage({ defaultMessage: "Land" })}
            name="country"
          ...
          <TextField
            name="countryArea"
            label={intl.formatMessage({ defaultMessage: "Staat/provincie" })}
