          ...
          <Online>
            <div className="overlay__header">
              <p className="overlay__header-text">
                <FormattedMessage defaultMessage="HybrIT account" />
              </p>
              <ReactSVG
                path={closeImg}
                onClick={hide}
            ...
            <div className="login__tabs">
              ...
              >
                <FormattedMessage defaultMessage="Log in op account" />
              </span>
              <span
              ...
              >
                <FormattedMessage defaultMessage="Registreer Nieuw Account" />
              </span>
            </div>
